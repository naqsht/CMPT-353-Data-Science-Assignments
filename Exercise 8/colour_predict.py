...
def main():
    ...
    bayes_convert_model = make_pipeline(FunctionTransformer(convert_RGBtoLAB), GaussianNB())

    # K Neighbors Classifier
    knn_rgb_model = KNeighborsClassifier()
    knn_convert_model = make_pipeline(FunctionTransformer(convert_RGBtoLAB), KNeighborsClassifier(n_neighbors=9))

    # Random Forest Classifier
    rf_rgb_model = RandomForestClassifier()
    rf_convert_model = make_pipeline(FunctionTransformer(convert_RGBtoLAB), RandomForestClassifier(n_estimators=150))
